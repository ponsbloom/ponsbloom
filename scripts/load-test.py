#!/usr/bin/env python3
"""
Ponsbloom network load test — escalating concurrency.

Usage:
    export PONSBLOOMENCE_API_KEY="your-key"
...
async def main():
    parser = argparse.ArgumentParser(description="Ponsbloom escalating load test")
    ...
    api_key = os.environ.get("PONSBLOOMENCE_API_KEY") or os.environ.get("PONSBLOOMENCE_ADMIN_KEY")
    if not api_key:
        print("Set PONSBLOOMENCE_API_KEY or PONSBLOOMENCE_ADMIN_KEY env var")
        sys.exit(1)

    model = MODEL_ALIASES.get(args.model, args.model)

    print(f"Ponsbloom Load Test")
    print(f"  Model:      {model}")
