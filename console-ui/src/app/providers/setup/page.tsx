...
const STEPS = [
  ...
  },
  {
    ...
    description: "Link this machine to your Ponsbloom account. You'll get a code to enter on the web to verify ownership.",
    command: "ponsbloom login",
  },
  {
    icon: Play,
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-12">
      ...
      <div className="text-center py-8">
        ...
        <p className="text-xs text-text-tertiary max-w-md mx-auto mt-3 leading-relaxed">
          Ponsbloom is an experimental research project in active development.
